...
const PapersResources = () => {
    ...
    const fetchResources = async () => {
      try {
        ...
        const response = await axios.get(
          "https://eduhub-backend-huep.onrender.com/student/papers-resources",
          {
            headers: {
  ...
  return (
    <div className="container">
        ...
        <h5>Papers</h5>
        <a href="/all-papers-resources"><button style={{background:'none',border:'none'}}>View all</button></a>
        </div>
      {resources.length > 0 ? (
...
export default PapersResources;
